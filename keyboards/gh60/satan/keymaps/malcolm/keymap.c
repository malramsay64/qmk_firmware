...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_60_ansi_split_bs_rshift(
        ...
        MO(1), KC_LGUI, KC_LALT, LT(1, KC_SPC),                    KC_RGUI, KC_RALT, MO(1), KC_RCTRL \
    ),
    /* 1: Fn layer
     * ,-----------------------------------------------------------.
     ...
     */
    LAYOUT_60_ansi_split_bs_rshift(
        ______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, BL_INC, BL_DEC, \
        KC_CAPS, ______, ______, ______, ______, ______, ______, KC_PGDN, KC_HOME, KC_PGUP, ______, ______,  BL_TOGG, KC_DEL, \
